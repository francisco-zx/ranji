...
<header class="js-head-main {% if head_transparent %}js-head-mutator{% endif %} {% if head_transparent_type_always %}head-transparent{% endif %} {% if head_transparent_type_on_section_above_the_fold %}head-transparent-on-section{% endif %} {% if head_transparent and settings.head_transparent_contrast_options %}head-transparent-contrast{% endif %} head-main {{ head_position_mobile }} {{ head_position_desktop }} transition-soft" data-store="head">
    ...
    <div class="container-fluid">
        <div class="{% if not settings.head_fix_desktop %}js-nav-logo-bar{% endif %} row no-gutters align-items-center">
            ...
            {% if logo_centered_desktop_without_hamburger %}
                <div class="{% if settings.logo_position_mobile == 'left' %}col-auto{% else %}col-3{% endif %} {% if settings.logo_position_desktop == 'left' %}col-md-auto{% else %}col-md-3{% endif %} {{ menu_mobile_utility_order_class }} {{ menu_desktop_utility_order_class }}">
                    ...
                    {# Navigation for desktop when logo centered without hamburger nav (no carousel) #}

                    <div class="header-utility d-none d-md-block">
            ...
            <div class="js-logo-col {% if settings.logo_position_mobile == 'left' or (settings.logo_position_mobile == 'center' and settings.utilities_type_mobile == 'text') %}col{% else %}{% if head_languages_centered_with_big_logo %}col-5{% else %}col-6{% endif %}{% endif %} {% if settings.logo_position_desktop == 'left' %}{% if settings.hamburger_desktop %}col-md{% else %}col-md-auto{% endif %}{% else %}col-md-6{% endif %} {{ logo_mobile_classes }} {{ logo_desktop_classes }}">
            ...
            <div class="{% if not settings.hamburger_desktop and settings.logo_position_desktop == 'left' %}js-desktop-search-cart-col desktop-search-cart-col{% endif %} {% if settings.logo_position_mobile == 'left' %}col-auto{% else %}{% if settings.utilities_type_mobile == 'text' %}{% if has_languages %}col-5{% else %}col-4{% endif %}{% else %}{% if head_languages_centered_with_big_logo %}col-4{% else %}col-3{% endif %}{% endif %}{% endif %} {% if settings.logo_position_desktop == 'left' %}col-md-auto{% else %}col-md-3{% endif %} d-flex align-items-center justify-content-end">
                ...
                <span class="js-search-utility header-utility {{ show_desktop_hide_mobile_class }}">
        ...
        {% if not settings.hamburger_desktop and settings.logo_position_desktop != 'left' and settings.logo_position_desktop != 'center' %}
